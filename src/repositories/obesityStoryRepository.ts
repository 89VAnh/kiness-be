...
export class ObesityStoryRepository {
    ...
    async createObesityStory(os: ObesityStoryModel) : Promise<any> {
        try {
            const sql = "CALL InsertObesityStory(?, ?, ?, ?, ?, ?, ?, @err_code, @err_msg)";
    ...
    async updateObesityStory(os: ObesityStoryModel) : Promise<any> {
        try {
            const sql = "CALL UpdateObesityStory(?, ?, ?, ?, ?, ?, ?, ?, @err_code, @err_msg)";
            await this.db.query(sql, [
                os.obesity_story_id,
                os.title,
                os.content,
    ...
    async searchClientObesityStories(search_client_os: SearchClientObesityStoryModel): Promise<any> {
        try {
            const sql = "CALL SearchClientObesityStories(?, ?, ?, @err_code, @err_msg)";
            const [results] = await this.db.query(sql, [
