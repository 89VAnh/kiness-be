...
export class GrowthArticleRepository {
    ...
    async createGrowthArticle(ga: GrowthArticleModel) : Promise<any> {
        try {
            const sql = "CALL InsertGrowthArticle(?, ?, ?, ?, ?, ?, ?, @err_code, @err_msg)";
    ...
    async updateGrowthArticle(ga: GrowthArticleModel) : Promise<any> {
        try {
            const sql = "CALL UpdateGrowthArticle(?, ?, ?, ?, ?, ?, ?, ?, @err_code, @err_msg)";
            await this.db.query(sql, [
    ...
    async searchClientGrowthArticles(search_client_ga: SearchClientGrowthArticleModel): Promise<any> {
        try {
            const sql = "CALL SearchClientGrowthArticles(?, ?, ?, @err_code, @err_msg)";
            const [results] = await this.db.query(sql, [
