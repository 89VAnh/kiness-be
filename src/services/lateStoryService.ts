...
export class LateStoryService {
    ...
    async getDetailClientLateStory(late_story_id: number): Promise<any> {
        return await this.lateStoryRepository.getDetailClientLateStory(late_story_id);
    }
    ...
    async searchClientLateStories(search_client_ls: SearchClientLateStoryModel): Promise<any> {
        return await this.lateStoryRepository.searchClientLateStories(search_client_ls);
    }
