...
export class UserService {
  constructor(private userRepository: UserRepository, private treeUltility: Tree
  ) {}
  ...
  async searchUser(pageIndex:number, pageSize:number, search_content:string, user_name:string, full_name:string, gender: number, date_of_birth: Date, email: string, phone_number:string , description:string): Promise<any> {
