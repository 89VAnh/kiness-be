...
export class PostureStoryService {
  ...
  async updateViewCountPostureStory(posture_story_id: number): Promise<any> {
    await this.postureStoryRepository.updateViewCountPostureStory(
      posture_story_id,
    );
  }
  ...
  async getDetailPostureStory(posture_story_id: number): Promise<any> {
    return await this.postureStoryRepository.getDetailPostureStory(
      posture_story_id,
    );
  }

  async getDetailClientPostureStory(posture_story_id: number): Promise<any> {
    return await this.postureStoryRepository.getDetailClientPostureStory(
      posture_story_id,
    );
  }
  ...
  async searchPostureStories(
    ...
    return await this.postureStoryRepository.searchPostureStories(
      search_ps_model,
    );
  }
  ...
  async searchClientPostureStories(
    ...
    return await this.postureStoryRepository.searchClientPostureStories(
      search_client_ps,
    );
  }
}
