...
growthArticleRouter.patch(
    ...
    growthArticleController.updateViewCountGrowthArticle.bind(growthArticleController)
);
...
growthArticleRouter.get(
    ...
    growthArticleController.getDetailClientGrowthArticle.bind(growthArticleController)
);
...
growthArticleRouter.post(
    "/search-client",
    growthArticleController.searchClientGrowthArticles.bind(growthArticleController)
);
