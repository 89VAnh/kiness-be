...
slideRouter.get(
  "/get-by-id/:id",
  slideController.getSlideById.bind(slideController),
);
slideRouter.get(
  "/dropdown",
  slideController.getSlideDropdown.bind(slideController),
);
slideRouter.post(
  "/create",
  authenticate,
  slideController.createSlide.bind(slideController),
);
slideRouter.post(
  "/update",
  authenticate,
...
slideRouter.post(
  "/delete",
  authenticate,
  slideController.deleteSlide.bind(slideController),
);
