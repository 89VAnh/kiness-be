...
cityRouter.post('/create', authenticate, cityController.createCity.bind(cityController));
cityRouter.post('/update', authenticate, cityController.updateCity.bind(cityController));
cityRouter.post('/delete', authenticate, cityController.deleteCity.bind(cityController));
