...
postureStoryRouter.get(
    ...
    postureStoryController.getDetailClientPostureStory.bind(postureStoryController)
);
...
postureStoryRouter.post(
    "/search-client",
    postureStoryController.searchClientPostureStories.bind(postureStoryController)
);
