...
userRouter.get('/get-by-id/:id', authenticate, userController.getUserById.bind(userController));
...
userRouter.post('/update', authenticate, userController.updateUser.bind(userController));
userRouter.post('/delete', authenticate, userController.deleteUser.bind(userController));
